...
/// Codex 复制安装命令弹窗
class CodexCopyCommandDialog extends StatefulWidget {
  const CodexCopyCommandDialog({super.key});

  /// 显示弹窗
  static Future<void> show(BuildContext context) {
    return showDialog(
      context: context,
      builder: (context) => const CodexCopyCommandDialog(),
    );
  }

  @override
  State<CodexCopyCommandDialog> createState() => _CodexCopyCommandDialogState();
}

class _CodexCopyCommandDialogState extends State<CodexCopyCommandDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final command = PlatformCommandsConfig.codexDisplayCommand;
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      S.get('codex_copy_install_command'),
