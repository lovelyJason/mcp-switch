...
/// Gemini Skill 详情弹窗
class _GeminiSkillDetailDialog extends StatefulWidget {
  final GeminiSkill skill;
  final VoidCallback onDeleted;

  const _GeminiSkillDetailDialog({
    required this.skill,
    required this.onDeleted,
  });

  @override
  State<_GeminiSkillDetailDialog> createState() => _GeminiSkillDetailDialogState();
}

class _GeminiSkillDetailDialogState extends State<_GeminiSkillDetailDialog> {
  ...
  Future<void> _deleteSkill() async {
    final confirmed = await CustomConfirmDialog.show(
      context,
      title: S.get('delete'),
      content: S.get('gemini_delete_skill_confirm').replaceAll('{name}', widget.skill.name),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.psychology, size: 22, color: Colors.green),
                  ),
