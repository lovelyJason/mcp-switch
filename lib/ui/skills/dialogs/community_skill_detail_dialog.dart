...
/// 社区 Skill 详情弹窗
class _CommunitySkillDetailDialog extends StatefulWidget {
  final CommunitySkill skill;
  final VoidCallback onDeleted;

  const _CommunitySkillDetailDialog({
    required this.skill,
    required this.onDeleted,
  });

  @override
  State<_CommunitySkillDetailDialog> createState() =>
      _CommunitySkillDetailDialogState();
}

class _CommunitySkillDetailDialogState extends State<_CommunitySkillDetailDialog> {
  ...
  Future<void> _openInFinder() async {
    await Process.run('open', ['-R', widget.skill.path]);
  }
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.folder_special, size: 22, color: Colors.teal),
                  ),
