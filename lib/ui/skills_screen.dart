...
import 'skills/components/hover_popover.dart';

// Part 文件 - Dialogs
part 'skills/dialogs/add_marketplace_dialog.dart';
part 'skills/dialogs/readme_viewer_dialog.dart';
part 'skills/dialogs/plugin_detail_dialog.dart';
part 'skills/dialogs/marketplace_detail_dialog.dart';
part 'skills/dialogs/skill_content_dialog.dart';
part 'skills/dialogs/community_skill_detail_dialog.dart';
part 'skills/dialogs/custom_skill_install_dialog.dart';
...
class _SkillsScreenState extends State<SkillsScreen> {
  ...
  Future<void> _openInFinder(String marketplace) async {
    ...
    final path = '$home/.claude/plugins/marketplaces/$marketplace';
